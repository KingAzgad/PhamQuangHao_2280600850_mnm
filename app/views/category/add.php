...
<div class="container mt-4">
    <h2>Thêm danh mục</h2>
    <form id="category-form" action="/webbanhang/category/save" method="post" novalidate>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-control"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
        </div>
